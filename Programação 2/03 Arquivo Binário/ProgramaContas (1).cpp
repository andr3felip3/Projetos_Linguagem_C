...
void deposito(int num, float valor){
	...
	if (posicao == -1)
	   ...
	   else {  // apos localizar a conta dentro do arquivo
	...
	if (posicao == -1)
	   printf("\n NAO localizou esta conta");
	   	     ...
	   	     if (arq!=NULL){
				 ...
				 else printf("\nSaldo insuficiente conta%d  saldo atual:$%5.2f  saque desejado:$%5.2f",cliente.num_conta,
				                      cliente.saldo, valor);
	             fclose(arq);
				 }
				 else 
...
main(){
	...
	while (opcao!=9){
		...
		printf("\n7 - Realizar DEPOSITO numa conta");
		printf("\n8 - Realizar SAQUE numa conta");
		printf("\n9 - SAir");
		printf("\nQual opcao?");
		scanf("%d",&opcao);
	    switch (opcao){
			...
			case 5: break;
			case 6: break;
			case 7: printf("\nEntre com conta a ser realizado o deposito:");scanf("%d",&num);
			        printf("\nentre com o valor do deposito:");scanf("%f",&valor);			
			        deposito(num,valor);
					break;	
			case 8: printf("\nEntre com conta a ser realizado o saque:");scanf("%d",&num);
			        printf("\nentre com o valor da retirada:");scanf("%f",&valor);			
			        saque(num,valor);
					break;				  			        
		}
	}
